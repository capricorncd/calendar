...
function Ot(t, e, s, n) {
  const a = t.map((i) => s ? p(i.fullText, s, n) : i.fullText);
  return e === H ? a[0] : a;
}
function jt(t) {
  const e = {
  ...
  return Object.keys(R).forEach((n) => {
    s = t[n], s && (!Array.isArray(R[n]) || R[n].includes(s)) && (e[n] = s);
...
const Bt = (t, e) => {
  ...
  mounted() {
    ...
    t.on("change", (e) => {
      this.value = Ot(e, this.mode, this.fmt, this.options.langPackage), this.$emit("change", this.value, e);
    }), t.on("error", (e) => {
      this.$emit("error", e);
    }), t.on("cancel", () => {
      this.$emit("cancel");
