...
|:--|:--|:--|:--|
|value|`string, timestamp, array`|`''`|Date selected by default|
...
|item-formatter|`function`|`undefined`|custom item handler, return an object|
...
|change|`function`|`undefined`|Parameters:(data, originalArrayData)|
|instance|`function`|`undefined`|Parameters:(calendarInstance), callback calendar instance|
|error|`function`|`undefined`|Parameters:(err)|
|cancel|`function`|`undefined`|Parameters:()|
